...
var_declaration: type_specifier ID_TOK ENDSTMT_TOK | type_specifier ID_TOK LBRACKET_TOK NUM_TOK RBRACKET_TOK ENDSTMT_TOK;
type_specifier: INT_TOK WHITESPACE_TOK | VOID_TOK WHITESPACE_TOK;
...
return_statement : WHITESPACE_TOK RETURN_TOK WHITESPACE_TOK ENDSTMT_TOK | WHITESPACE_TOK RETURN_TOK WHITESPACE_TOK expression ENDSTMT_TOK;
expression : var ASSIGN_TOK expression | simple_expression;
var : ID_TOK | ID_TOK LBRACKET_TOK expression RBRACKET_TOK;
simple_expression : additive_expression relopp additive_expression | additive_expression;
relopp : WHITESPACE_TOK relop WHITESPACE_TOK | relop
